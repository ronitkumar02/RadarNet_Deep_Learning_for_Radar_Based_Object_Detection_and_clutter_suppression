...
for i = 13:30
    %try
        ...
        %random_sealength=randi([2e3,3e3],1,1)
         random_m1=1*rand(1,1)
         random_m=random_m1*(random_t_ang/20)*rand(1,1)
         random_k1=1*rand(1,1)
         random_k=random_k1*(random_t_ang/20)*rand(1,1)
        ppiNoClutter(randLen, randWidth, randHt, file1,random_m,random_m1,random_k,random_k1,random_t_ang,random_t_deg,random_t_deg1)
        ppiClutter(randLen, randWidth, randHt, file2,random_m,random_m1,random_k,random_k1,random_t_ang,random_t_deg,random_t_deg1)
    %catch
        %i=i-1;
        %disp("ERROR!!!!!!!!!!!!!!!!!")
        %continue
